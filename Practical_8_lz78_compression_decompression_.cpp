...
// 190420116054
// Data Compression
// Practical 8: LZ 78 compression and decompression algorithm
...
int main()
{
	...
	cout<<"\n190420116054 : Manish Prajapati\n\nPractical No. 8: Encode a given input file using dictionary method \"LZ78\" and store the result in file.\n\n";
	cout<<"This is LZ78 File compression and Decompression Algorithm.\n\n";
